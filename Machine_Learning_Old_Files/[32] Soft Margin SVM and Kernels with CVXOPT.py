...
# this program can work only using debugging Ghasak note
# reason maybe because of using the pylab which we dont use anymore, its canceled since 2010.
import numpy as np
from numpy import linalg
import cvxopt  # This package is compatible with Python 3.6
